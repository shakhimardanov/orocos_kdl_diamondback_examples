...
// The only major difference of this code to matlab version is
//that matlab aligns initial pose along +X (since this is supported in robotics toolbox)
//here we align initial position around -Y
